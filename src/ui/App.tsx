import { Calculator, ChevronDown, ChevronUp, FileSpreadsheet, PieChart, Printer, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-neutro-hueso text-azul-600 font-sans p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 border-b-2 border-azul-600/10 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="font-serif text-2xl md:text-[28px] font-bold text-azul-600 flex items-center gap-2 leading-tight">
                <Calculator className="w-7 h-7 text-cian-600 md:hidden" />
              ...
              <p className="text-neutro-grafito mt-2 flex flex-wrap items-center gap-2 text-sm">
                ...
                ISR (Anexo 8 RMF 2026) · Subsidio (Decreto DOF 31-12-2025) · IMSS/INFONAVIT (LSS 2026) · LFT 2026
                <span className="text-[10px] text-neutro-grafito">{VERSION_NORMATIVA}</span>
              </p>
            </div>
          </div>
        ...
        <section className="mt-8 bg-white rounded-2xl shadow-sm border border-neutro-niebla overflow-hidden">
          <button
            type="button"
          ...
          <div className="bg-neutro-hueso p-4 text-center border-t border-neutro-niebla">
            <p className="text-xs text-neutro-grafito">
              Cesantía y Vejez patronal conforme a la columna 2026 del Transitorio Segundo del Decreto DOF 16-12-2020 (art. 168-II-a LSS). Precisión completa; redondeo a centavos sólo al mostrar.
            </p>
            <p className="mt-2 flex justify-center gap-2 items-center text-sm font-semibold text-azul-600">
